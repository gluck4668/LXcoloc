...
} else  #-----if(nrow(gwas_data_info)>0)----
  print("The smaple information could not be obtained because R package couldn't access the GWAS Catalog online. ")
