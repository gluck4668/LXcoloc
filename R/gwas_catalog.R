...
print("-----------------------------------------------------------------------------------------------")
print("Please visit 'https://www.ebi.ac.uk/gwas/downloads' to get the smaple information using a Windows Browser. ")
stop(" The 'https://www.ebi.ac.uk/gwas/downloads' could not be connected. ")
}
