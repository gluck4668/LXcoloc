...
#------sample information---------------------------------
tryCatch(sample_infor <- sample_info(eqtlID,samplesize_eqtl_file,outcomeID,samplesize_gwas),error = function(e) {e})

if(!exists("sample_infor")){
print("Sorry, LXcoloc package could not get the smaple information because it couldn't access the GWAS Catalog online.")
stop("Please visit 'https://www.ebi.ac.uk/gwas/downloads' to get the smaple information. ")
}
